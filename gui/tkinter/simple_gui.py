...
column1 = [
    [
        sg.Text(
            "Column 1", background_color="#d3dfda", justification="center", size=(10, 1)
        )
    ],
...
layout = [
    [
        sg.Text(
            "All graphic widgets in one window!", size=(30, 1), font=("Helvetica", 25)
        )
    ],
    ...
    [
        sg.Text(
            "Your Folder", size=(15, 1), auto_size_text=False, justification="right"
        ),
